                        ...
                        <div id="signup_div_wrapper">
                            ...
                            <form class="register" id="signupForm">
                                ...
                                <p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
                                    ...
                                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="firstName" id="inputFirstName" value=""  required/>
                                </p>

                                <p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
                                    <label for="inputLastName">Last Name <span class="required">*</span></label>
                                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="lastName" id="inputLastName" value=""  required />
                                </p>
...
<script type="text/javascript">
    ...
    function signupProcess(encPassword) {
        ...
        $.ajax({
            url : "/json/signUpProcess",
            type: "post",
            data: JSON.stringify({email: email, password: encPassword, name:name}),
            contentType: "application/json",
            success : function(data, textStatus, jqXHR) {
